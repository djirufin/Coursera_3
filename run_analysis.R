...
x_train <- read.table(paste(folder_list[[1]], '/X_', folder_list[[1]], '.txt', sep = ''))
y_train <- read.table(paste(folder_list[[1]], '/y_', folder_list[[1]], '.txt', sep = ''))
sub_train <- read.table(paste(folder_list[[1]], '/subject_', folder_list[[1]], '.txt', sep = ''))
